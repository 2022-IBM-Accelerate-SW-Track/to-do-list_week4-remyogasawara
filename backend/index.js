// Note: This snippet of code is importing external modules and 
// setting the environment variables. Make sure to replace <port> 
// with a port number of your choosing such as 8080 or 3001 keep 
// note of this port number for future usage. Click on the following 
// links express, cors, body-parser, and fs to learn more about these
...
// Note: This snippet of code takes in a request body from the Todo 
// List Application which represents a todo item. The body is then 
// converted into a new json object called newTask to represent the 
// new todo item. The new json object is finally appended to a json 
